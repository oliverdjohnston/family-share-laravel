        ...
        <MainLayout title="Steam Dashboard" description="Analyze and compare Steam library data">
            <div className="max-w-8xl container mx-auto flex min-h-[calc(100vh-4rem)] flex-col px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
                ...
                <div className="mb-6 grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-4 lg:mb-8 lg:grid-cols-4">
                    ...
                    <StatCard
                        title={`Library Value (${valueTypeLabel})`}
                    ...
                    <StatCard
                        ...
                        icon={CalendarIcon}
                    />
                    <StatCard title="Next Purchaser" value="N/A" description="Coming soon" icon={TrendingUpIcon} />
                </div>

                <div className="bg-muted mb-4 grid h-auto w-full grid-cols-4 gap-1 rounded-md p-1 sm:mb-6">
                    {DASHBOARD_TABS.map((tab) => (
                        <Button
                            ...
                            className={cn(
                                "cursor-pointer px-3 py-2 text-xs capitalize sm:text-sm",
